 ...
 *    2 - full debug
 *
 * TEMPORARY: REMOVE THESE NEXT SEMESTER:       --- TODO TODO TODO ---
 *    3 - full debug, and also disable the opcode & funct fields after fill_CPUControl()
 *   -1 - no   debug, but      disable the opcode & funct fields after fill_CPUControl()
 */
